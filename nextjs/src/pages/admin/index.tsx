...
export default function AdminPage({ products }: { products: Product[] }) {
  return (
    <div className={styles.mainContainer}>
      ...
      <h2 style={{ color: '#4E2A0F', marginBottom: '1rem' }}>All Products</h2>

      {loading ? (
        <p style={{ textAlign: 'center', color: '#4E2A0F' }}>Loading products...</p>
      ) : products.length === 0 ? (
        <p style={{ textAlign: 'center', color: '#4E2A0F' }}>No products found.</p>
      ) : (
